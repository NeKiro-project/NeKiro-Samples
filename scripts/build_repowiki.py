#!/usr/bin/env python3
"""Build the bilingual MkDocs source tree from the Samples Markdown."""
...
SOURCE_URL_PREFIX = "https://github.com/NeKiro-project/NeKiro-Samples/blob/main/"
MARKDOWN_LINK = re.compile(r"(?<!!)(\[[^\]]+\])\(([^)]+)\)")
H1 = re.compile(r"^#\s+(.+?)\s*$")
SOURCES = (
    ("README.md", "source-docs/overview.md"),
    ("runtime-a/README.md", "source-docs/runtime-a.md"),
    ("runtime-b/README.md", "source-docs/runtime-b.md"),
)
...
def source_index(language: str) -> str:
    if language == "zh":
        lines = [
            "# 源文档",
            "",
            "以下页面从 Samples 仓库内的 canonical Markdown 文档生成。",
